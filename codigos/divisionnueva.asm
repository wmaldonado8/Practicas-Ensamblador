...
section .bss
		...
		resultado_AH resb 1 ;para crear una variable se pone el nombre el RESB y el numero de bits
...
_start:
		...
		div bl   ;se esta multiplicando al= al*bl porque solo hay un operando osea no se pone ,
		add al,'0'
		add ah,'0'
